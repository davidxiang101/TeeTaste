...
def scrapeOldNavyFashion(url, folderName, maxImages):
    driver.get(url)
...
if not os.path.exists("images/OldNavyImages"):
    os.makedirs("images/OldNavyImages")

maxImages = 300

url = "https://oldnavy.gap.com/browse/category.do?cid=11174#department=75&style=85060,1005526&facetOrder=department:75,style:85060,style:1005526"
scrapeOldNavyFashion(url, "images/OldNavyImages", maxImages)
