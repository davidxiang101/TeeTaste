...
def scrapeGapFashion(url, folderName, maxImages):
    ...
    while len(unique_images) < maxImages:
        try:
            ...
            images = driver.find_elements(By.CSS_SELECTOR, 'img.plp-slick-img loaded ')
...
if not os.path.exists("images/TommyHilfigerImages"):
    os.makedirs("images/TommyHilfigerImages")

maxImages = 100

url = "https://usa.tommy.com/en/men/clothing/t-shirts?sz=90&start=0"
scrapeGapFashion(url, "images/TommyHilfigerImages", maxImages)
